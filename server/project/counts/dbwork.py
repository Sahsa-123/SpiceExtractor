import sqlite3, os, json, numpy

with open('parse.json', 'r', encoding='utf-8') as file:
    d = file.read()
    d = json.loads(d)
...
create_table_data(d)
create_table_header(d)


with open('get.json', 'w') as file:
    json.dump(get_plots('Kristal_0p6_waf0chip1_D06p_W35_L3p5_soi_dc_idvg_300K_DATA'), file, indent=4)
