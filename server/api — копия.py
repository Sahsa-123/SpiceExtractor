...
#             data1['inner-nominal-fielset'].append({'value': transistor_type[0]})
...
#         else:
#             return '_'.join([chip_number, transistor_type, characteristic, temperature, radiancy]) + '_DATA'
#     return -1
...
# @app.get("/plot")
# def get_plot(chip_number: str,
#                 transistor_type: str,
#                  characteristic: str,
#                    temperature: str,
#                    radiancy: str):
#     url = make_url_for_database(chip_number,
#                                 transistor_type,
#                                 characteristic,
#                                 temperature,
#                                 radiancy)
