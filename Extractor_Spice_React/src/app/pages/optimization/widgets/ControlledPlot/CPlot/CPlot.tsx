...
export const CPlot: React.FC<CPlotI> = ({ height, width, outerStyles }) => {
  ...
  const plots = [
    {
      key: 'IDVD',
      data: data.pointIDVD.data,
      layout: data.pointIDVD.layout,
      error: data.errIDVD ?? 0,
    },
    {
      key: 'IDVG',
      data: data.pointIDVG.data,
      layout: data.pointIDVG.layout,
      error: data.errIDVG ?? 0,
    },
  ];
